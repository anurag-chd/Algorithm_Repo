...
public class ConvertBalancedBST {
	...
	public static binaryTree.TreeNode convertBST(binaryTree.TreeNode root,boolean asc){
		if(root == null){
			return null;
		}
		else{
	...
	public static int maxLeftHeight(binaryTree.TreeNode root){
		if(root == null){
			return 0;
		}
		else{
	...
	public static int maxRightHeight(binaryTree.TreeNode root){
		if(root == null){
			return 0;
		}
		else{
